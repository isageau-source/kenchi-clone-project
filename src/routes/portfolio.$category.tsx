...
const GALLERIES: Record<string, Gallery> = {
  ...
  "concreting-driveways": {
    ...
    description:
      "Kenchi offers a variety of high quality concreting solutions for all your residential and commercial landscaping needs. We supply and place concrete for driveways, paths, footings and slabs. Options include broom finish, coloured, exposed aggregate, decorative mosaic stone and sprayed finishes. We can also lay natural stone, cobblestones and tiles for an enhanced look.",
    slides: [
      { src: "https://kenchi.com.au/static/uploads/images/wftkyhjlnizn2-wfbefzcgqeit.jpg?mode=max&upscale=false&width=1400", caption: "Australian Porphyry Stone" },
      { src: "https://kenchi.com.au/static/uploads/images/wfodlrulxkpr-wfmsgboukapr.jpg?mode=max&upscale=false&width=1400", caption: "Driveway Detail" },
      { src: "https://kenchi.com.au/static/uploads/images/wftyeztaklml-wfexvkecwwyp.jpg?mode=max&upscale=false&width=1400", caption: "Concrete Driveway" },
      { src: "https://kenchi.com.au/static/uploads/images/wfbdiklxwwkx-wfivyptlsudl.jpg?mode=max&upscale=false&width=1400", caption: "Exposed Aggregate" },
      { src: "https://kenchi.com.au/static/uploads/images/wfonjcmtvsqr2-wfjqtqikgzih.jpg?mode=max&upscale=false&width=1400", caption: "Decorative Concrete" },
      { src: "https://kenchi.com.au/static/uploads/images/wftbtxvzrntt-wfxopeakrnqd.jpg?mode=max&upscale=false&width=1400", caption: "Coloured Concrete" },
      { src: "https://kenchi.com.au/static/uploads/images/wfeptehtbuqe-wfnjhwdbjmuy.jpg?mode=max&upscale=false&width=1400", caption: "Broom Finish Path" },
      { src: "https://kenchi.com.au/static/uploads/images/wfkoaxrhbfsi-wfwnbeeiofvv.jpg?mode=max&upscale=false&width=1400", caption: "Driveway & Entry" },
      { src: "https://kenchi.com.au/static/uploads/images/wfwxttbbktlx-wfheprlqsdic.jpg?mode=max&upscale=false&width=1400", caption: "Sprayed Concrete Finish" },
      { src: "https://kenchi.com.au/static/uploads/images/wfedwtrqswmk-wfjttslpaaxq.jpg?mode=max&upscale=false&width=1400", caption: "Concrete Slab" },
      { src: "https://kenchi.com.au/static/uploads/images/wfgqnvwgrfyy-wfnetagvfqdt.jpg?mode=max&upscale=false&width=1400", caption: "Concrete Pathway" },
      { src: "https://kenchi.com.au/static/uploads/images/wfmjqainpbps-wfejvkdzsgup.jpg?mode=max&upscale=false&width=1400", caption: "Mosaic Stone Concrete" },
      { src: "https://kenchi.com.au/static/uploads/images/wfktclknonnn-wfpkanxvbmmj.jpg?mode=max&upscale=false&width=1400", caption: "Residential Driveway" },
      { src: "https://kenchi.com.au/static/uploads/images/wfhtzbxtslwr-wfhsivjtprfs.jpg?mode=max&upscale=false&width=1400", caption: "Commercial Concreting" },
      { src: "https://kenchi.com.au/static/uploads/images/wfosgqqpelyy-wfuesmxuqeqb.jpg?mode=max&upscale=false&width=1400", caption: "Concrete & Stone Detail" },
      { src: "https://kenchi.com.au/static/uploads/images/wfwzziicanal-wfhkbaitiqbu.jpg?mode=max&upscale=false&width=1400", caption: "Driveway Finish" },
      { src: "https://kenchi.com.au/static/uploads/images/wfxdzogbidui-wfunfwpnjpgo.jpg?mode=max&upscale=false&width=1400", caption: "Stone Pathway" },
      { src: "https://kenchi.com.au/static/uploads/images/wflgonpbavth-wfcgewpreznd.jpg?mode=max&upscale=false&width=1400", caption: "Feature Stone Surround" },
    ],
  },
